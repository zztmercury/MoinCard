...
public class ActivityInfo implements java.io.Serializable {
    ...
    public ActivityInfo(String activityId, String name, String brief, String address, Integer level, String detail, String img, String briefImg, java.util.Date startDate, java.util.Date endDate, Boolean isTop, Boolean isOfficial, Boolean isAttend, Boolean isViewed, int type, Integer num, String merchantId) {
        this.activityId = activityId;
        this.name = name;
        this.brief = brief;
