...
public class ImageInfo {
    ...
    public ImageInfo(JSONObject jsonObject) throws JSONException {
        width = jsonObject.getInt(Config.KEY_MERCHANT_IMG_WIDTH);
        height = jsonObject.getInt(Config.KEY_MERCHANT_IMG_HEIGHT);
        color = Color.parseColor(jsonObject.getString(Config.KEY_MERCHANT_IMG_COLOR));
        url = jsonObject.getString(Config.KEY_MERCHANT_IMG_URL);
        desc = jsonObject.getString(Config.KEY_MERCHANT_IMG_DESCRIPTION);
    }
    // KEEP METHODS END
