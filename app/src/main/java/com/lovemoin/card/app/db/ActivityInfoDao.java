...
public class ActivityInfoDao extends AbstractDao<ActivityInfo, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property IsOfficial = new Property(12, Boolean.class, "isOfficial", false, "IS_OFFICIAL");
        public final static Property IsAttend = new Property(13, Boolean.class, "isAttend", false, "IS_ATTEND");
        public final static Property IsViewed = new Property(14, Boolean.class, "isViewed", false, "IS_VIEWED");
        public final static Property Type = new Property(15, int.class, "type", false, "TYPE");
        public final static Property ShareUrl = new Property(16, String.class, "shareUrl", false, "SHARE_URL");
        public final static Property Num = new Property(17, Integer.class, "num", false, "NUM");
        public final static Property MerchantId = new Property(18, String.class, "merchantId", false, "MERCHANT_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ACTIVITY_INFO\" (" + //
                ...
                "\"URL\" TEXT," + // 8: url
                "\"START_DATE\" INTEGER NOT NULL ," + // 9: startDate
                "\"END_DATE\" INTEGER NOT NULL ," + // 10: endDate
                "\"IS_TOP\" INTEGER," + // 11: isTop
                "\"IS_OFFICIAL\" INTEGER," + // 12: isOfficial
                "\"IS_ATTEND\" INTEGER," + // 13: isAttend
                "\"IS_VIEWED\" INTEGER," + // 14: isViewed
                "\"TYPE\" INTEGER NOT NULL ," + // 15: type
                "\"SHARE_URL\" TEXT," + // 16: shareUrl
                "\"NUM\" INTEGER," + // 17: num
                "\"MERCHANT_ID\" TEXT);"); // 18: merchantId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, ActivityInfo entity) {
        ...
        stmt.bindLong(10, entity.getStartDate().getTime());
        stmt.bindLong(11, entity.getEndDate().getTime());
    ...
    public ActivityInfo readEntity(Cursor cursor, int offset) {
        ActivityInfo entity = new ActivityInfo( //
            ...
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // briefImg
                ...
                new java.util.Date(cursor.getLong(offset + 9)), // startDate
                new java.util.Date(cursor.getLong(offset + 10)), // endDate
                cursor.isNull(offset + 11) ? null : cursor.getShort(offset + 11) != 0, // isTop
                cursor.isNull(offset + 12) ? null : cursor.getShort(offset + 12) != 0, // isOfficial
                cursor.isNull(offset + 13) ? null : cursor.getShort(offset + 13) != 0, // isAttend
                cursor.isNull(offset + 14) ? null : cursor.getShort(offset + 14) != 0, // isViewed
                cursor.getInt(offset + 15), // type
                cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16), // shareUrl
                cursor.isNull(offset + 17) ? null : cursor.getInt(offset + 17), // num
                cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18) // merchantId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ActivityInfo entity, int offset) {
        ...
        entity.setStartDate(new java.util.Date(cursor.getLong(offset + 9)));
        entity.setEndDate(new java.util.Date(cursor.getLong(offset + 10)));
        entity.setIsTop(cursor.isNull(offset + 11) ? null : cursor.getShort(offset + 11) != 0);
        entity.setIsOfficial(cursor.isNull(offset + 12) ? null : cursor.getShort(offset + 12) != 0);
        entity.setIsAttend(cursor.isNull(offset + 13) ? null : cursor.getShort(offset + 13) != 0);
        entity.setIsViewed(cursor.isNull(offset + 14) ? null : cursor.getShort(offset + 14) != 0);
        entity.setType(cursor.getInt(offset + 15));
        entity.setShareUrl(cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16));
        entity.setNum(cursor.isNull(offset + 17) ? null : cursor.getInt(offset + 17));
        entity.setMerchantId(cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18));
     }
