...
public class MerchantInfo {
    ...
    public MerchantInfo(String merchantId, String merchantName, String brand, String mainImg, String brief, String description) {
        this.merchantId = merchantId;
    ...
    public List<CardInfo> getCardInfoList() {
        if (cardInfoList == null) {
            ...
            List<CardInfo> cardInfoListNew = targetDao._queryMerchantInfo_CardInfoList(merchantId);
            synchronized (this) {
                if (cardInfoList == null) {
    ...
    public List<ImageInfo> getImageInfoList() {
        if (imageInfoList == null) {
            ...
            List<ImageInfo> imageInfoListNew = targetDao._queryMerchantInfo_ImageInfoList(merchantId);
            synchronized (this) {
                if (imageInfoList == null) {
    ...
    public List<ActivityInfo> getActivityInfoList() {
        if (activityInfoList == null) {
            ...
            List<ActivityInfo> activityInfoListNew = targetDao._queryMerchantInfo_ActivityInfoList(merchantId);
            synchronized (this) {
                if (activityInfoList == null) {
    ...
    public List<StoreInfo> getStoreInfoList() {
        if (storeInfoList == null) {
            ...
            List<StoreInfo> storeInfoListNew = targetDao._queryMerchantInfo_StoreInfoList(merchantId);
            synchronized (this) {
                if (storeInfoList == null) {
